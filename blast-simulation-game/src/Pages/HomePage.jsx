...
function HomePage() {
  ...
  return (
    <div className="background text-center fixed inset-0 flex flex-col justify-center h-screen w-full p-3 sm:p-4 lg:p-4 overflow-hidden">
      ...
      {/* Form Section */}
      <form className="flex flex-col items-center w-full max-w-[872px] mx-auto sm:mt-2" onSubmit = {handleContinue}>
        <div
